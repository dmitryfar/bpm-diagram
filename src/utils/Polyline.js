...
export function Anchor(uuid, type, x, y) {
	this.uuid = uuid;
	this.x = x;
	this.y = y;
...
Polyline.prototype = {
	...
	pushAnchor: function(type, x, y, index){
      ...
      this.typeIndex = 0;
		...
		var anchor = new Anchor(this.id, ANCHOR_TYPE.main, x, y, index, this.typeIndex);
...
export function Polygone(points, strokeWidth) {
	/* Array on coordinates:
	 * points: [{x: 410, y: 110}, 1
	 *			{x: 570, y: 110}, 1 2
	 *			{x: 620, y: 240},   2 3
